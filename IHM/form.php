                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form id="register-form" action="https://phpoll.com/register/process" method="post" role="form" style="display: none;">
                                    ...
                                    <div class="form-group">
                                        <input type="password" name="username" id="username" tabindex="1" class="form-control" placeholder="Mot de passe" value="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="date" name="date" id="date" tabindex="1" class="form-control" value="">
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-offset-3">
